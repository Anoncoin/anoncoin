Anoncoin Core version *0.15.1* is now available from:

  <https://download.anoncoin.org/anoncoin-0.15.1/>
...
A number of changes to the way Anoncoin Core deals with peer connections and invalid blocks
