...
* anoncoin.conf: contains configuration settings for anoncoind or anoncoin-qt
* anoncoind.pid: stores the process id of anoncoind while running
...
* debug.log: contains debug information and general logging generated by anoncoind or anoncoin-qt
