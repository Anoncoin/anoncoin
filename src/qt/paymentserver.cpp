...
const char* BIP71_MIMETYPE_PAYMENT = "application/anoncoin-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/anoncoin-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/anoncoin-paymentrequest";
