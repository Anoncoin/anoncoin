...
public:
    CMainParams() {
        ...
        vSeeds.push_back(CDNSSeedData("anoncash.net", "seed.anoncash.net"));                                         //Normal DNSSeed
        vSeeds.push_back(CDNSSeedData("frank2.net", "seed.frank2.net"));
        vSeeds.push_back(CDNSSeedData("anoncash.net", "seed2.anoncash.net"));
        vSeeds.push_back(CDNSSeedData("anoncash.net", "seed4.anoncash.net"));                                            //Normal DNSSeed
        ...
        // Irignal
        i2pvSeeds.push_back(CDNSSeedData("5vjnm2tb7zlyjwmfeeqvxz65wdqhgdgbyo5gjs6f3tlruivtnewa.b32.i2p", "5vjnm2tb7zlyjwmfeeqvxz65wdqhgdgbyo5gjs6f3tlruivtnewa.b32.i2p"));
