...
const char * const BITCOIN_CONF_FILENAME = "anoncoin.conf";
const char * const BITCOIN_PID_FILENAME = "anoncoind.pid";
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Anoncoin";
#else
    // Unix
