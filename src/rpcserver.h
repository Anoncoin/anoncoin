...
#ifndef ANONCOINRPC_SERVER_H
#define ANONCOINRPC_SERVER_H

// Many builder specific things set in the config file, ENABLE_WALLET is a good example.  Don't forget to include it
...
extern bool EnsureWalletIsAvailable(bool avoidException);      //! Defined in rpcwallet.cpp
extern void EnsureWalletIsUnlocked();                          //! Defined in rpcwallet.cpp

extern json_spirit::Value destination(const json_spirit::Array& params, bool fHelp); // in rpcnet.cpp
...
extern json_spirit::Value gethashmeter(const json_spirit::Array& params, bool fHelp);
...
extern json_spirit::Value getretargetpid(const json_spirit::Array& params, bool fHelp);
// These are only included in pre-release builds for developers
...
extern void InitializeTestNetBlocks();
#endif // ANONCOINRPC_SERVER_H
